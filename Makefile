...
ui_newgamefilemanager.h: newgamefilemanager.ui \
		/usr/lib/qt5/bin/uic
	/usr/lib/qt5/bin/uic newgamefilemanager.ui -o ui_newgamefilemanager.h
...
gamestatemanager.o: gamestatemanager.cpp gamestatemanager.h \
		...
		Stock.h \
		json.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gamestatemanager.o gamestatemanager.cpp

gamestatebase.o: gamestatebase.cpp gamestatebase.h \
		gamestatemanager.h \
		UserManager.h \
		User.h \
		Portfolio.h \
		...
		Stock.h \
		json.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gamestatebase.o gamestatebase.cpp
...
newgamestate.o: newgamestate.cpp newgamestate.h \
		decorator.h \
		gamestatemanager.h \
		UserManager.h \
		User.h \
